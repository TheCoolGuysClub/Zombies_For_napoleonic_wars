...
#  ("window_night",0,"window_night","0", []),
 ...
 ("headquarters_flag_sarranid",sokf_static_movement|sokf_face_player,"0","0", []),
 ...
 # MM
 ("ctf_flag_kingdom_1", sokf_moveable, "ctf_flag_britain", "0", []),
 ("ctf_flag_kingdom_2", sokf_moveable, "ctf_flag_france", "0", []),
 ("ctf_flag_kingdom_3", sokf_moveable, "ctf_flag_prussia", "0", []),
 ("ctf_flag_kingdom_4", sokf_moveable, "ctf_flag_russia", "0", []),
 ("ctf_flag_kingdom_5", sokf_moveable, "ctf_flag_austria", "0", []),
 ("ctf_flag_kingdom_6", sokf_moveable, "ctf_flag_russia", "0", []),
 ("ctf_flag_kingdom_7", sokf_moveable, "ctf_flag_rebel", "0", []),

 ("headquarters_flag_rebel",sokf_moveable|sokf_face_player,"rebbleflag","0", []),
...
################################
    ...
    ("mm_tree_aspen3" ,sokf_handle_as_flora,"mm_aspen3" ,"bo_mm_aspen1" , []),
    ("mm_tree_aspen4" ,sokf_handle_as_flora,"mm_aspen4" ,"bo_mm_aspen1" , []),
    ("mm_tree_aspen5" ,sokf_handle_as_flora,"mm_aspen5" ,"bo_mm_aspen1" , []),
    ("mm_tree_aspen6" ,sokf_handle_as_flora,"mm_aspen6" ,"bo_mm_aspen1" , []),
    ("mm_tree_aspen7" ,sokf_handle_as_flora,"mm_aspen7" ,"bo_mm_aspen1" , []),
    ("mm_tree_aspen8" ,sokf_handle_as_flora,"mm_aspen8" ,"bo_mm_aspen1" , []),
    ("mm_tree_aspen9" ,sokf_handle_as_flora,"mm_aspen9" ,"bo_mm_aspen1" , []),
    ("mm_tree_aspen10" ,sokf_handle_as_flora,"mm_aspen10" ,"bo_mm_aspen1" , []),
    ("mm_tree_aspen11" ,sokf_handle_as_flora,"mm_aspen11" ,"bo_mm_aspen1" , []),
    ("mm_tree_aspen12" ,sokf_handle_as_flora,"mm_aspen12" ,"bo_mm_aspen1" , []),
    ...
    ("mm_tree_northern4" ,sokf_handle_as_flora,"mm_northern_tree4" ,"bo_mm_winter_tree15" , []),
    ...
    ("mm_tree_winter5" ,sokf_handle_as_flora,"mm_winter_tree4" ,"bo_mm_autumn_tree1" , []),
    ...
    ("mm_tree_winter8" ,sokf_handle_as_flora,"mm_winter_tree7" ,"bo_mm_winter_tree6" , []),
    ("mm_tree_winter9" ,sokf_handle_as_flora,"mm_winter_tree8" ,"bo_mm_winter_tree6" , []),
    ("mm_tree_winter10" ,sokf_handle_as_flora,"mm_winter_tree9" ,"bo_mm_winter_tree6" , []),
    ("mm_tree_winter11" ,sokf_handle_as_flora,"mm_winter_tree10" ,"bo_mm_winter_tree6" , []),
    ("mm_tree_winter12" ,sokf_handle_as_flora,"mm_winter_tree11" ,"bo_mm_winter_tree6" , []),
    ...
    ("mm_tree_vegetation6" ,sokf_handle_as_flora,"mm_vegetation_tree6" ,"bo_mm_vegetation_tree3" , []),
    ...
    ("mm_tree_vegetation2_6" ,sokf_handle_as_flora,"mm_vegetation_tree26" ,"bo_mm_vegetation_tree3" , []),
    ...
    ("mm_tree_vegetation3_6" ,sokf_handle_as_flora,"mm_vegetation_tree36" ,"bo_mm_vegetation_tree3" , []),
    ...
    ("mm_tree_vegetation7_6" ,sokf_handle_as_flora,"mm_vegetation_tree76" ,"bo_mm_vegetation_tree3" , []),
    ...
    ("mm_tree_vegetation8_6" ,sokf_handle_as_flora,"mm_vegetation_tree86" ,"bo_mm_vegetation_tree3" , []),
    ...
    ("mm_tree_vegetation9_6" ,sokf_handle_as_flora,"mm_vegetation_tree96" ,"bo_mm_vegetation_tree3" , []),
    ...
    ("mm_tree_vegetation10_11" ,sokf_handle_as_flora,"mm_vegetation_tree1011" ,"bo_mm_vegetation_tree411" , []),
    ...
    ("mm_tree_vegetation11_11" ,sokf_handle_as_flora,"mm_vegetation_tree1111" ,"bo_mm_vegetation_tree411" , []),
...
("aagreenscreen" ,0,"greenscreen" ,"0" , []),
 ...
 # la haye saint
    ...
    ("mm_la_haye2" ,0,"la_haye_saint1" ,"bo_la_haye_saint1" , []),
   ...
   ("mm_ice4" ,0,"ice4" ,"bo_ice4" , []),
    ...
    ("mm_window1",sokf_static_movement|sokf_destructible,"window1","bo_window1", [check_mm_on_destroy_window_trigger,(ti_on_scene_prop_use,[]),]),
  ...
  #    check_common_construction_props_use_trigger,
   ...
   # ("mm_sp_rich_street6",0,"sp_rich_village_street6","bo_sp_rich_village_street6", []),
    ...
    ("mm_howitzer_push_button",sokf_moveable|spr_use_time(1),"0","12wheels",[
      check_mm_use_cannon_prop_start_trigger,
      check_mm_use_cannon_prop_end_trigger,
      check_mm_use_cannon_prop_cancel_trigger,
    ]),
    ("mm_fort_push_button",sokf_moveable|spr_use_time(1),"0","fortwheels",[
      check_mm_use_cannon_prop_start_trigger,
      check_mm_use_cannon_prop_end_trigger,
      check_mm_use_cannon_prop_cancel_trigger,
    ]),
    ("mm_naval_push_button",sokf_moveable|spr_use_time(1),"0","navalwheels",[
      check_mm_use_cannon_prop_start_trigger,
      check_mm_use_cannon_prop_end_trigger,
      check_mm_use_cannon_prop_cancel_trigger,
    ]),
    ...
    ("mm_earth_dig2" ,sokf_moveable,"mm_shovel_earth1" ,"bo_mm_shovel_earth1" , [check_common_earth_on_hit_trigger,]),
...
("ambience_sound_global_city_empty",0,"0" ,"0" , [
 ...
 #For bots
 ("formation_locator",sokf_moveable|sokf_face_player,"ctf_flag_britain","0", []),
 ("formation_locator_2",sokf_moveable|sokf_face_player,"ctf_flag_france","0", []),
 ...
 ("mm_sp_crate_explosive",sokf_moveable|sokf_dynamic_physics|sokf_destructible,"barreltriangulated" ,"barreltriangulated_collision" , [
  (ti_on_init_scene_prop,
    [
      ...
      (prop_instance_dynamics_set_properties, ":prop_id", pos0),
      (position_set_x, pos0, 300),
